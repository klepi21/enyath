...
export default function Component() {
  ...
  const handleMint = async () => {
    if (minterInfo) {
      ...
      const pricePerNFT = parseFloat(minterInfo.token_price) / 1e18;
      const valueToSend = BigInt(pricePerNFT * amountOfTokens * 1e18);
    ...
    <Card className="w-full max-w-6xl bg-gradient-to-br from-slate-900 to-blue-900 text-white border-0 shadow-2xl shadow-blue-500/20 overflow-hidden">
      <CardContent className="p-0">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            <Image 
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-u7HEzxMry2ocSUgeB8fhX0q1Q2fVDO.png"
